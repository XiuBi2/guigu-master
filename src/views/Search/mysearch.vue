            ...
            <div class="navbar-inner filter">
              ...
              <ul class="sui-nav">
                <li :class="{ active: isOne }" @click="changeOrder('1')">
                  <a>综合<span v-show="isOne" class="iconfont" :class="{ 'icon-jiantou_xiangxia': isAsc, 'icon-jiantou_xiangshang': isDesc }"></span></a>
                </li>
                <li :class="{ active: isTwo }" @click="changeOrder('2')">
                  <a>价格<span v-show="isTwo" class="iconfont" :class="{ 'icon-jiantou_xiangxia': isAsc, 'icon-jiantou_xiangshang': isDesc }" icon-jiantou_xiangxia></span></a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <ul class="yui3-g">
              <li class="yui3-u-1-5" v-for="item in goodsList" :key="item.id">
                <div class="list-wrap">
                  ...
                  <div class="attr">
                    <a target="_blank" href="item.html" title="促销信息，下单即赠送三个月CIBN视频会员卡！【小米电视新品4A 58 火爆预约中】" v-html="item.title"></a>
                  </div>
                  <div class="commit">
