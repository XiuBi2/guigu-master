              ...
              <table class="order-item" v-for="order in myOrder.records" :key="order.id">
                ...
                <tbody>
                  <tr v-for="(cart, index) in order.orderDetailList" :key="cart.id">
                    ...
                    <td width="8%" class="center" v-if="index == 0" :rowspan="order.orderDetailList.length">{{ order.consignee }}</td>
                    <td width="13%" class="center" v-if="index == 0" :rowspan="order.orderDetailList.length">
                      <ul class="unstyled">
                        <li>总金额¥{{ order.totalAmount }}.00</li>
                        <li>在线支付</li>
                      </ul>
                    </td>
                    <td width="8%" class="center" v-if="index == 0" :rowspan="order.orderDetailList.length">
